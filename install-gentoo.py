...
if missing_pkgs:
    ...
    call(["make", "all"]) 
#Notes to DSHELL TEAM. can TRIM this DOWN if you wish. this is hear as a conviniance to you. 
...
# for Sabayon (Gentoo overlay , Binary Distro of Gentoo) USers will need to Run equo i + missing_pkgs & or allow the emerge to post
...
print("equo rescue spmsync, to do this , else entropy; Your binary pkg-manager may not be aware that is is installed")
